...
import { ContentPasteSearch, CorporateFare, Dashboard, FlakySharp, LocationOn, Settings, Storage } from '@mui/icons-material';
...
export const SIDE_MENU = [
    { title: 'Dashboard', icon: <Dashboard className='icn' />, path: '/' },
    // { title: 'Accounts', icon: <AccountBoxIcon className='icn' />, path: '/accounts' },
    { title: 'Inspection Detail', icon: <ContentPasteSearch className='icn' />, path: '/inspection-details' },
    { title: 'Phase Comparison', icon: <FlakySharp className='icn' />, path: '/phase-compare' },
    // {
