...
//             let accessToken = store.getState().auth.user?.token;

//             // 🔥 KEY FIX: If no access token OR session might be invalid → verify via refresh
//             if (!accessToken) {
//             try {
...
const basicAuthHeader =
  'Basic ' + btoa(`${import.meta.env.VITE_API_USR}:${import.meta.env.VITE_API_PSS}`);
